...
前提となるキット 『YUME』 については[こちらのReadme](https://github.com/Qoo622/3D-print/tree/master/Yume-Vision/YUME_v1)を合わせて必ず参照してください。
...
| 操作系統用基板 | JLCPCB等に依頼して基板を作成してもらってください。また、別途スイッチ等のハンダ付けが必要です。 | 1つ |
