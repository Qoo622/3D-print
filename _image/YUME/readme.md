...
## 概要
夢ビジョンの映像に熱源を可視化した映像を重ね合わせる『フュージョン』と言われる視界を実現するシステムです。  
夢ビジョン単体ではIRライトの補助がないと完全暗所で視界を確保するのは厳しいですが、本機はサーマルの支援を受けることで視界を補助し、使い方次第では昼間でも偽装などに対する強力な視覚補助を得ることができます。  
